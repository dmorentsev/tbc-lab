...
locals {
  domain_name = "davidmorentsev.site" # trimsuffix(data.aws_route53_zone.this.name, ".")
  subdomain   = "tbc-lab"
}
...
module "cloudfront" {
  ...
  origin_access_identities = {
    s3_bucket_one = "TBC CloudFront can access"
  }
  ...
  viewer_certificate = {
    acm_certificate_arn = "arn:aws:acm:us-east-1:533267139597:certificate/9cc6a462-0f58-4470-8f32-0c004bdddc90" #module.acm.acm_certificate_arn
